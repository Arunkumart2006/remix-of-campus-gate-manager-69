    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans overflow-x-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={() => navigate("/login")}
            className="px-8 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-base transition-all duration-200 hover:shadow-xl hover:shadow-blue-600/30 active:scale-95 w-full sm:w-auto"
          >
            Get Started →
          </button>
          <a
        ...
        <div className="max-w-lg mx-auto">
          <div className="relative p-8 rounded-3xl bg-gray-900 border border-white/5 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-600/15 border border-blue-500/20 text-blue-400 text-xs font-medium mb-5">
